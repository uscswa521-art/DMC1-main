...
const translations: Record<LangCode, Translations> = {
  'zh-TW': {
    ...
    training: {
      ...
      videos: [
        { title: '盤口超核心', category: '基礎核心' },
        { title: '短線交易秘訣', category: '交易策略' },
        { title: 'ICT 時間', category: '進階技術' },
        { title: '酒田戰法', category: '經典技法' },
        { title: '一目均衡表', category: '指標應用' },
        { title: '看懂邏輯 DMC策略', category: '思維認知' },
      ],
    },
    bitunix: {
  ...
  'zh-CN': {
    ...
    training: {
      ...
      videos: [
        { title: '盘口超核心', category: '基础核心' },
        { title: '短线交易秘诀', category: '交易策略' },
        { title: 'ICT 时间', category: '进阶技术' },
        { title: '酒田战法', category: '经典技法' },
        { title: '一目均衡表', category: '指标应用' },
        { title: '看懂逻辑 DMC策略', category: '思维认知' },
      ],
    },
    bitunix: {
