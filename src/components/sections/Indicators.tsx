    ...
    <section id="indicators" className="relative py-32 bg-[#050508]">
      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-[#111713] rounded-lg border border-neon-green/15 shadow-[0_0_40px_rgba(13,242,88,0.25)] overflow-hidden">
            <div className="bg-[#1A201C] p-4 flex items-center border-b border-neon-green/15">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
              <div className="p-8 border-b md:border-b-0 md:border-r border-neon-green/15 space-y-6">
              ...
              <div className="p-8 border-b lg:border-b-0 lg:border-r border-neon-green/15 space-y-6">
                <div className="space-y-4 text-sm font-code">
              ...
              <div className="p-8 space-y-6 bg-black/40">
                <div className="space-y-6">
                  <div className="p-4 bg-[#050508] border border-white/5 rounded-lg">
                    <p className="text-xs font-code text-muted-foreground uppercase mb-2">{t.indicators.requirementLabel}</p>
