  ...
  return (
    <div className="p-5 w-64 space-y-3">
      ...
      <div className="pt-2 border-t border-neon-green/10">
        <p className="text-white/30 font-code text-[9px] tracking-widest uppercase mb-2">Follow Us</p>
        <div className="flex items-center gap-2">
          <a href="#" aria-label="Facebook"
            className="w-8 h-8 rounded-full bg-[#1877F2]/15 hover:bg-[#1877F2] border border-[#1877F2]/40 flex items-center justify-center transition-all duration-200 hover:scale-110">
            <svg viewBox="0 0 24 24" className="fill-[#1877F2]" style={{width:'15px',height:'15px'}}>
              <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
            </svg>
          </a>
          <a href="#" aria-label="YouTube"
            className="w-8 h-8 rounded-full bg-[#FF0000]/15 hover:bg-[#FF0000] border border-[#FF0000]/40 flex items-center justify-center transition-all duration-200 hover:scale-110">
            <svg viewBox="0 0 24 24" className="fill-[#FF0000]" style={{width:'15px',height:'15px'}}>
          ...
          <a href="#" aria-label="Telegram"
            className="w-8 h-8 rounded-full bg-[#26A5E4]/15 hover:bg-[#26A5E4] border border-[#26A5E4]/40 flex items-center justify-center transition-all duration-200 hover:scale-110">
            <svg viewBox="0 0 24 24" className="fill-[#26A5E4]" style={{width:'15px',height:'15px'}}>
          ...
          <a href="#" aria-label="Discord"
            className="w-8 h-8 rounded-full bg-[#5865F2]/15 hover:bg-[#5865F2] border border-[#5865F2]/40 flex items-center justify-center transition-all duration-200 hover:scale-110">
            <svg viewBox="0 0 24 24" className="fill-[#5865F2]" style={{width:'15px',height:'15px'}}>
          ...
          <a href="#" aria-label="Instagram"
            className="w-8 h-8 rounded-full bg-[#E1306C]/15 hover:bg-[#E1306C] border border-[#E1306C]/40 flex items-center justify-center transition-all duration-200 hover:scale-110">
            <svg viewBox="0 0 24 24" className="fill-[#E1306C]" style={{width:'15px',height:'15px'}}>
