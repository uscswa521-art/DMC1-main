  ...
  return (
    <section className="relative min-h-screen bg-[#050508] text-white overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 lg:px-12 py-32">
        ...
        {/* ── Back link ── */}
        <div className="mb-10">
          <a href="/about" className="text-white/30 hover:text-neon-green font-code text-xs tracking-wider transition-colors">
            ← 關於 DMC
          </a>
        </div>
        ...
        <div className="max-w-3xl mx-auto mb-24">
          <div className="relative p-8 rounded-2xl border border-neon-green/20 bg-neon-green/[0.03]">
            <div className="absolute -top-3 left-8">
              <span className="bg-[#050508] text-neon-green font-code text-[10px] tracking-widest uppercase border border-neon-green/30 rounded px-2 py-0.5">
                核心主張
              </span>
            </div>
        ...
        <div className="max-w-5xl mx-auto mb-24">
          <h2 className="text-2xl font-headline font-bold text-white mb-3 text-center">DMC 三大核心支柱</h2>
          <p className="text-white/30 font-code text-xs text-center tracking-wider mb-10">三個維度相互驗證，缺一不可</p>
            ...
            {DMC_PILLARS.map((p, i) => (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-white font-headline font-bold text-lg mb-0.5 group-hover:text-neon-green transition-colors">{p.title}</h3>
        ...
        <div className="max-w-4xl mx-auto mb-24">
          <h2 className="text-2xl font-headline font-bold text-white mb-3 text-center">DMC vs SMC / SNR</h2>
          <p className="text-white/30 font-code text-xs text-center tracking-wider mb-10">為什麼專業交易者選擇 DMC？</p>
          <div className="rounded-2xl overflow-hidden border border-neon-green/12">
            ...
            {COMPARE.map((row, i) => (
              <div key={i} className={`grid grid-cols-3 ${i < COMPARE.length - 1 ? "border-b border-neon-green/8" : ""}`}>
        ...
        <div className="max-w-2xl mx-auto mb-20 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-2">
            {["加密貨幣合約", "外匯 Forex", "美股期貨", "黃金 XAU", "指數期貨"].map((m) => (
              <span key={m} className="px-3 py-1.5 rounded-full border border-neon-green/20 bg-neon-green/[0.04] text-neon-green/60 font-code text-xs">
                {m}
              </span>
            ))}
          </div>
        ...
        <div className="text-center space-y-4">
          <p className="text-white/35 font-code text-xs tracking-wider">想深入了解？</p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <a href="/david" className="inline-flex items-center gap-2 px-7 py-3 rounded-xl font-headline font-black text-sm text-white border border-neon-green/30 bg-neon-green/5 hover:bg-neon-green/10 hover:border-neon-green/50 transition-all duration-200">
              認識大衛 →
            </a>
            <a href="/community" className="inline-flex items-center gap-2 px-7 py-3 rounded-xl font-headline font-black text-sm text-black transition-all duration-200 hover:opacity-90 hover:scale-105"
...
export default function WhatIsDMCPage() {
  return (
    <LanguageProvider>
